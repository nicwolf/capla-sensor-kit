...
*/
void ModbusMaster::preTransmission(void (*preTransmission)(void *), void *arg)
{
  _preTransmission = preTransmission;
  _preTransmissionArg = arg;
}
...
*/
void ModbusMaster::postTransmission(void (*postTransmission)(void *), void *arg)
{
  _postTransmission = postTransmission;
  _postTransmissionArg = arg;
}
...
uint8_t ModbusMaster::ModbusMasterTransaction(uint8_t u8MBFunction)
{
  ...
  if (_preTransmission)
  {
    _preTransmission(_preTransmissionArg);
  }
  for (i = 0; i < u8ModbusADUSize; i++)
  {
  ...
  {
    _postTransmission(_postTransmissionArg);
  }
